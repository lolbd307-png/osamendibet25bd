...
const paymentMethods = [
  { id: "bkash", name: "বিকাশ", color: "bg-[hsl(330,80%,45%)]", number: "01XXXXXXXXX" },
  { id: "nagad", name: "নগদ", color: "bg-[hsl(25,90%,50%)]", number: "01XXXXXXXXX" },
  { id: "rocket", name: "রকেট", color: "bg-[hsl(270,60%,45%)]", number: "01XXXXXXXXX" },
];
      ...
      >
            ...
            {paymentMethods.map((m) => (
              ...
              >
                <div className={`w-10 h-10 rounded-full ${m.color} flex items-center justify-center`}>
                  <span className="text-xs font-bold text-foreground">{m.name[0]}</span>
                </div>
        ...
        <div>
          ...
          <Input
            ...
            className="bg-card border-border focus:border-primary h-12 text-foreground"
          />
        </div>
        ...
        <p className="text-xs text-muted-foreground text-center">
          সর্বনিম্ন ৳৫০০ • সর্বোচ্চ ৳৫০,০০০ • ১-৫ মিনিটে জমা হবে
        </p>
      </motion.div>
