...
const Register = () => {
  ...
  const [form, setForm] = useState({ name: "", phone: "", password: "", confirmPassword: "", referral: "" });
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-10 bg-secondary border-border focus:border-primary h-12 text-foreground"
            />
            <button
              type="button"
          ...
          <Input
            ...
            className="bg-secondary border-border focus:border-primary h-12 text-foreground"
          />
